...
import {ErrorValidation} from "../components/Errors/ErrorValidation/ErrorValidation";
    ...
    render() {
        return (
            <div style={{position: 'absolute',  right: '16%'}}>
                <svg width={32} height={32} {...this.props}
                     onMouseOver={() => this.onChangeMouseFlag(true)} onMouseOut={() => this.onChangeMouseFlag(false)}>
                    <rect
                        fill="#db3c30"
                        width={28}
                        height={28}
                ...
                {this.state.flagMouse && <ErrorValidation error={this.props.error}/>}
            </div>
        )
    }
}
